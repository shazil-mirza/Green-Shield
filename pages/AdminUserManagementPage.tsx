  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mb-4 relative">
        <input
          type="text"
          placeholder="Search users by email, role, plan, or status..."
            ...
            {filteredUsers.map(user => (
              <tr key={user.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 capitalize">
                    {user.stripeSubscriptionStatus ? user.stripeSubscriptionStatus.replace('_', ' ') : (user.planType === 'free' ? 'N/A (Free Plan)' : 'N/A')}
                </td>
      ...
      {editingUser && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md">
            <h3 className="text-xl font-semibold mb-4">Edit User Role: {editingUser.email}</h3>
